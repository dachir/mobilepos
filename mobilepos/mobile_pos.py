    ...
    for d in dates_list: # [start_limit: end_limit]:
        ...
        if details_doc:
            ...
            args = {
                ...
                "cash_value": ((sum_doc[0].total_credit - sum_doc[0].paid_amount) if sum_doc[0].total_credit - sum_doc[0].paid_amount > 0 else 0.0) if sum_doc and sum_doc[0].total_credit and sum_doc[0].paid_amount else 0.0,
                "details": details,
            }
